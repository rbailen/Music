/*Crea una vista que te permita recuperar toda la información relevante de
la canción “Walking by myself”.*/

CREATE OR REPLACE VIEW cancion_view(CANCION, LP, ARTISTA, MUSICO, INSTRUMENTO, OTRO, LETRISTA, PRODUCTOR, LETRA)
AS
